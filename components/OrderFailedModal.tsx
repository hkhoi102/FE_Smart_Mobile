    ...
    >
      <View style={styles.orderFailedOverlay}>
        <View style={styles.orderFailedModal}>
          ...
          <Text style={styles.failedTitle}>Oops! Order Failed</Text>
          <Text style={styles.failedSubtitle}>Something went terribly wrong.</Text>
          <View style={styles.failedButtonContainer}>
            ...
            <TouchableOpacity onPress={onBackToHome} style={styles.backToHomeFailedButton}>
              <Text style={styles.backToHomeFailedText}>Back to home</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
